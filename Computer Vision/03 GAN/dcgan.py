...
class G(nn.Module): 
    ...
    def __init__(self): 
        ...
        # We inherit from the nn.Module tools. Super to activate the inheritance 
        self.main = nn.Sequential( 
            ...
            # 100 for input, 512 feature map output, kernel of size 4, stride of 1 and padding of 0
            nn.BatchNorm2d(512), 
            ...
            # We add another inversed convolution.
            # As fake images would be 3 channels
            nn.Tanh() 
...
class D(nn.Module): # We introduce a class to define the discriminator.
    ...
    def __init__(self): 
        ...
        self.main = nn.Sequential( 
            ...
            # LRelu = negative values for -x. just works better in Dicriminator. 0.2 is the negative slope
    ...
    def forward(self, input): 
        ...
        # and that will return the output which will be a value between 0 and 1.
        output = self.main(input) 
        # input would be a vecrtor of 100
        # We forward propagate the signal through the whole neural network of the discriminator defined by self.main.
        return output.view(-1) 
        # to flatten the result of the convolution to 1D
